...
![Micro Service Architecture](/images/msvc_image.png)
...
![Data Processing Diagram](/images/msvc_image-2.png)
...
The SalesLT.Customer table had been classified by [Microsoft Purview](https://learn.microsoft.com/en-us/purview/data-map) to contain encryption data for user passwords that cannot be stored in an analytical data store according to the corporate data protection policies and therefore needs to be removed.
